    ...
    internal static class FitnessFunctionsMcx
    {
        ...
        private static double RpnlDayFactor(BacktestRequest request, ICollection<RunResponse> results)
        {
            ...
            for (var day = 0; day < totalDays; day++)
            {
                ...
                //var np = dayTrades.Last().Np - dayTrades.First().Np;
                //todo: differently
                //todo: make sure trading above open price
        ...
        public static FitnessComposition NpaRrr(BacktestRequest request, ICollection<RunResponse> results)
        {
            ...
            //const double rpnlWeight = 0.45;
            //const double pppyWeight = 0.20;
            //const double ipdrWeight = 0;
            //const double tradeCountWeight = 0.10;
            ...
            // Rule set
            // - dont close below enter price -> only positive rpnl?
            //     - penalize negative rpnl
